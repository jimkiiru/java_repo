...
<title>Edit Constitution | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<center><h3>
		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-3">EDIT CONSTITUTION
					INFORMATION </span>
			</div>
			<form:form action="updateConstitution.do" method="post"
				commandName="editConstitution">
				<table class="table ">
					<tr>
						<td>
						...
						<td>
							<div class="form-group col-md-12">
								<div class="col-md-7">
									<label for="UpLoad Constitution">Upload Constitution</label>
									<form:input path="constUrl" cssClass="form-control"
										name="fileUpload" type="file" />
									<form:errors path="constUrl" cssStyle="color:red"></form:errors>
								</div>
							</div>
						</td>
					</tr>
					<tr>
						<td colspan="3" align="center"><input type="submit" name=""
							...
							onclick="javascript:deleteConstitution('deleteConstitution.do?fieldid=${editConstitution.fieldid}');">
							&nbsp;&nbsp; <input type="button" value="Back"
							class="btn btn-warning"
							onclick="javascript:go('viewAllConstitutions.do');"></td>
					</tr>
				</table>
			</form:form>
			</div>

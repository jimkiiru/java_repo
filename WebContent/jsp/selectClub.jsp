...
<title>Search Officials | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container table-danger">
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-4">VIEW CLUB OFFICIALS</span>
			</div>
			<center><h4><font style="color:red;">N/B.All fields with (*) are mandatory fields.</font></h4></center>
			<form:form action="selectclub2.do" method="post"
				commandName="selectClub">
				<table class="table ">
					<tr>
						<div class="row">
							<td>
								<div class="form-group col-md-12">
									...
									color="red">*</FONT></label>
										<form:select cssClass="form-control" path="clubName">
											<form:option value="NONE" label="--- Select Club---" />
											<form:options items="${clubs}" />
										</form:select>
							...
							<td>
								<div class="form-group col-md-12">
									<div class="col-md-7">
										<label for="First Name">Year<FONT
									color="red">*</FONT></label> <input
											class="form-control" name="year" placeholder="Enter year" required/>

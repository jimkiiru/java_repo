...
<title>Administrator Dashboard | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-4">WELCOME TO ADMIN DASHBOARD</span>
			</div>
			<div class="panel-body col-lg-offset-1">
				<table class="table">
					<tbody>
						<tr>
							<td><a href="viewAllConstitutions.do"><button
										class="btn btn-primary btn-size">VIEW CONSTITUTIONS</button></a></td>
							<td><a href="viewDeactivatedClubs.do"><button
										class="btn btn-primary btn-size">VIEW DEACTIVATED
										CLUBS</button></a></td>
						</tr>
						<tr>
							<td><a href="viewAllClubs.do"><button
										class="btn btn-primary btn-size">VIEW REGISTERED
										CLUBS</button></a></td>
							<td><a href="viewDelayedReport.do"><button
										class="btn btn btn-primary btn-size">DELAYED MONTHLY
										REPORTS</button></a></td>
						</tr>
						<tr>
							<td><a href="selectclub.do"><button
										class="btn btn btn-primary btn-size">VIEW
										OFFICIALS</button></a></td>
							<td><a href="viewAllReports.do"><button
										class="btn btn btn-primary btn-size">MONTHLY
										REPORTS</button></a></td>
						</tr>
						<tr>
							<td><a href="saveAdmin.do"><button
										class="btn btn-primary btn-size">ADD ADMINISTRATOR</button></a></td>
							<td><a href="viewAllEvents.do"><button
										class="btn btn-primary btn-size">VIEW EVENTS</button></a></td>
						</tr>
						<tr>
							<td><a href="selectmenu.do"><button
										class="btn btn-primary btn-size">VIEW MEMBERS</button></a></td>
							<td><a href="saveCategory.do"><button
										class="btn btn-primary btn-size">ADD CATEGORY</button></a></td>
						</tr>
		...
		<nav>
			<ul class="pager">
				...
				<li class="next"><a href="viewAllConstitutions.do">Next<span

...
<title>Reset Password | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container table-danger">
		<center><h4 style="color: red;">${returnMessage}</h4></center>
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-4">RESET PASSWORD FORM</span>
			</div>
			<center><h4><font style="color:red;">N/B.All fields with (*) are mandatory fields.</font></h4></center>
			<form:form action="changepass.do" method="post"
				commandName="RPassword">
				<table class="table ">
					<tr>
						<div class="row">
							<td>
								<div class="form-group col-lg-offset-4">
									<div class="col-md-5">
										<label for="Email Address">Username<font
					...
					<tr>
						<div class="row">
							<td>
								<div class="form-group col-lg-offset-4">
									<div class="col-md-5">
										<label for="Password">Old password<font
											style="color: red">*</font></label> <input type="password"
					...
					<tr>
						<div class="row">
							<td>
								<div class="form-group col-lg-offset-4">
									<div class="col-md-5">
										<label for="Password">New password<font
											style="color: red">*</font></label> <input type="password"

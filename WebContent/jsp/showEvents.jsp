...
<title>Registered Events | DeKUT Clubs Manager</title>
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
	<form action="searchEvents.do" method="post">
				<div class="panel panel-info">
				<div class="panel-heading">
					<span class="lead">UPLOADED EVENTS</span> &nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="input-search" type="text"
						placeholder="Search event by club name" name="eventid" size="25" />
		...
		<table class="table pure-table pure-table-bordered pure-table-striped">
			...
			<c:if test="${! empty SEARCH_CONTACTS_RESULTS_KEY}">
				<c:forEach var="event" items="${SEARCH_CONTACTS_RESULTS_KEY}">
					<tr>
						<td><c:out value="${event.clubname}"></c:out></td>
						<td><c:out value="${event.eventName}"></c:out></td>
						<td><c:out value="${event.eventPlace}"></c:out></td>
						<td><c:out value="${event.url}"></c:out></td>
						<td>&nbsp;&nbsp;&nbsp;<a
							href="downloadEvent.do?url=${event.url}"><span
								class="fa fa-download"></span></a>
						</td>
						<td><a class="btn btn-danger"
							href="javascript:deleteEvent('deleteEvent.do?eventid=${event.eventid}');"><span
	...
	<nav>
			<ul class="pager">
				...
				<li class="next"><a href="selectmenu.do">Next<span

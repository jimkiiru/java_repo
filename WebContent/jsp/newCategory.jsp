...
<title>Register Club Category | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<meta name="generator"
	content="Joomla! - Open Source Content Management" />
<title>Admin Dashboard | DeKUT Clubs Manager</title>
<!--Images icon-->
<link rel="shortcut icon" href="images/favcon.PNG" />
<link href="css/bootstrap-theme.css" rel="stylesheet">
<link href="css/bootstrap.css" rel="stylesheet">
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<div class="panel  panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-4">CATEGORY REGISTRATION FORM</span>&nbsp;&nbsp;

			</div>
			<form:form action="saveCategory.do" method="post"
				commandName="newCategory">
				<table class="table ">
					<tr>
						<td>
							<div class="form-group col-md-12">
								<div class="col-md-offset-4 col-md-4">
									<label for="Category Name">Category Name<font
										style="color: red;">*</font></label> <input placeholder="Enter category name"Class="form-control"

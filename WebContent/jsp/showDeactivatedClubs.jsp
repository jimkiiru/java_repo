...
<title>Deactivated Clubs | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<form action="searchClubs.do" method="post">
			<div class="panel panel-info">
				<div class="panel-heading">
					<span class="lead text-left">Deactivated Clubs</span> &nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<c:if test="${! empty list}">
				<c:forEach var="club" items="${list}">
					<tr>
						...
						<td>&nbsp;&nbsp;<a
							href="javascript:activateClub('activateClub.do?clubid=${club.clubid}');">Activate</a>
						</td>
	...
	<nav>
		<ul class="pager">
			...
			<li class="next"><a href="viewAllClubs.do">Next<span

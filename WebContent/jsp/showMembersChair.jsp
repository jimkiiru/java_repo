...
<title>Registered Members | DeKUT Clubs Manager</title>
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<form action="searchMember.do" method="post">
			<div class="panel panel-info">
				<div class="panel-heading">
					<span class="lead">REGISTERED MEMBERS</span> &nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"
						placeholder="Search Member by First name" name="fname" size="25" />
			...
			<c:if test="${! empty list}">
				<c:forEach var="member" items="${list}">
					<tr>
						...
						<td>&nbsp;<a 
							href="updateMember.do?memberid=${member.memberid}"><span
								class="fa fa-pencil-square-o"></span></a>
						</td>
						<td>&nbsp;&nbsp;<a class="btn btn-danger"
							href="javascript:deleteMember('deleteMember.do?memberid=${member.memberid}');">

...
<title>Registered Administrators | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead">REGISTERED ADMINISTRATORS</span>&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="text" placeholder="Search by first name"
						name="clubname" /> &nbsp;&nbsp;<input type="submit"
						class="btn btn-danger" value="Search" />
				</form>
			</div>
			<center>
				<table
					class="table pure-table pure-table-bordered pure-table-striped">
					...
					<c:if test="${! empty SEARCH_CONTACTS_RESULTS_KEY}">
						<c:forEach var="admin" items="${SEARCH_CONTACTS_RESULTS_KEY}">
							<tr>
								<td><c:out value="${admin.first_name}"></c:out></td>
								<td><c:out value="${admin.lname}"></c:out></td>
								<td><c:out value="${admin.emailaddress}"></c:out></td>
								<td><c:out value="${admin.cellphone}"></c:out></td>
								<td><c:out value="${admin.password}"></c:out></td>
								<td>&nbsp;<a href="updateAdmin.do?adminid=${admin.adminid}"><i
										class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
									&nbsp;&nbsp;
								</td>
								<td><a class="btn btn-danger"
									href="javascript:deleteAdmin('deleteAdmin.do?adminid=${admin.adminid}');"><i

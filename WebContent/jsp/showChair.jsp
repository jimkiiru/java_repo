...
<title>DeKUT Clubs Manager</title>
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<div class="container">
		...
		<table class="table pure-table pure-table-bordered pure-table-striped">
			...
			<c:if test="${! empty list}">
			<c:forEach var="chair" items="${list}">
				<tr>
					<!-- <td><c:out value="${member.memberid}"></c:out></td> -->
					<td><c:out value="${chair.first_name}"></c:out></td>
					<td><c:out value="${chair.lname}"></c:out></td>
					<td><c:out value="${chair.regnum}"></c:out></td>
					<td><c:out value="${chair.emailaddress}"></c:out></td>
					<td><c:out value="${chair.cellphone}"></c:out></td>
					<td><c:out value="${chair.clubName}"></c:out></td>
					<td>&nbsp;<a class="btn btn-danger"
						href="updateChair.do?chairid=${chair.chairid}"><span

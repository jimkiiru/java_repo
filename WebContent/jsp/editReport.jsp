...
<title>Edit Report | DeKUT Clubs Manager</title>
<!--Images icon-->
...
<body data-spy="scroll" data-target="#my-navbar">
	...
	<center><h3>
		...
		<div class="panel panel-info">
			<div class="panel-heading">
				<span class="lead col-lg-offset-3">EDIT REPORT INFORMATION </span>
			</div>
			<center>
				<form:form action="updateReport.do" method="post"
					commandName="editReport" enctype="multipart/form-data">
					<table class="table ">
					<tr>
							<td>
								<div class="form-group col-md-12">
									<div class="col-md-7">
										<label for="Club id">File id</label>
										<form:input cssClass="form-control" path="count"
											readonly="true" />
										<form:errors path="count" cssStyle="color:red"></form:errors>
									</div>
								</div>
							</td>
						</tr>
							...
							<td>
								<div class="form-group col-md-12">
									<div class="col-md-7">
										...
										<form:input cssClass="form-control" path="clubid"
											readonly="true" />
						...
						<tr>
							<td>
								<div class="form-group col-md-12">
									<div class="col-md-7">
										<label for="Upload report">Upload report</label> <input
											path="url" cssClass="form-control" name="fileUpload"
											type="file" />
						...
						<tr>
							<td colspan="3" align="center"><input type="submit"
								...
								class="btn btn-info"
								onclick="javascript:deleteReport('deleteReport.do?count=${editReport.count}');">
								&nbsp;&nbsp; <input type="button" class="btn btn-warning"
								value="Back" onclick="javascript:go('viewAllReports.do');"></td>
						</tr>
					</table>
				</form:form>
				</td>
